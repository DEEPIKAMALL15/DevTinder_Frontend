...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    socket.on('messageReceived', ({ firstName, lastName, text, userId: senderId }) => {
  ...
  return (
    <div className='w-3/4 mx-auto border border-gray-600 m-5 h-[75vh] flex flex-col'>
      <h1 className='p-5 border-b border-gray-400'>
...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    socket.on('messageReceived', ({ firstName, lastName, text, userId: senderId, photoUrl }) => {
      setMessages((messages) => [
        ...messages,
        { firstName, lastName, text, userId: senderId, photoUrl },
      ]);
    });
          ...
          return (
            <div key={index} className={`flex ${isSender ? 'justify-end' : 'justify-start'}`}>
              ...
              >
                ...
                <div
                  className={`px-4 py-2 rounded-2xl text-sm leading-6 break-words ${
